...
<div class="container-fluid">
  <div class="row">
    ...
    <div class="row">
      ...
      <form method="post" action="../controller/bookcontroller.php?action=update" enctype="multipart/form-data">
<div class="form-body">
<?php if(isset($_GET['msg1']) ){?><div class="alert alert-success">Book Edited Successfully</div><?php }?>
  <div class="form-group row">
    ...
    <div class="col-md-9">
     <input type="text" name="isbn" id="isbn" placeholder="ISBN" class="form-control" value="<?php echo $rowBook['isbn']; ?>"/>
  ...
  <div class="form-group row">
    ...
    <div class="col-md-9">
     <input type="text" name="book_title" id="book_title" placeholder="Book Title" class="form-control" value="<?php echo $rowBook['book_title']; ?>" "/>
...
<div class="col-md-9">
  <div class="radio-list">
    <input type="text" name="author_name" id="author_name" placeholder="Author Name" class="form-control" value="<?php echo $rowBook['author_name']; ?>" />
...
<div class="col-md-9">
   <textarea class="form-control" rows="3" name="description"><?php echo $rowBook['book_des']; ?></textarea>
</div>
</div>
...
<button type="submit" class="btn btn-success"> <i class="fa fa-check"></i>Update Book</button>
